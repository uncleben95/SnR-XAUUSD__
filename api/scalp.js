...
export default async function handler(req, res) {
  ...
  async function maybeSendSignalPush(signal, marketSession, price, m5Analysis, m15Analysis, h1Analysis, signalKey) {
  ...
  try {
    ...
    const pushResult = await maybeSendSignalPush(
      signal, marketSession, price, m5Analysis, m15Analysis, h1Analysis, signalKey
    );
