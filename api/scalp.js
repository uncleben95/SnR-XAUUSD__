...
export default async function handler(req, res) {
  ...
  async function maybeSendSignalPush(signal, marketSession, price, m5Analysis, m15Analysis, h1Analysis) {
    ...
    if (previous?.direction === direction) {
      return { attempted: false, sent: 0, reason: "ALREADY_NOTIFIED", lastDirection: direction };
    }
