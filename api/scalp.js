...
export default async function handler(req, res) {
  ...
  try {
    ...
    return res.status(200).json({
      ...
      version:
        "V16-SCALP-BACKGROUND-PUSH-ENTRY-CHOCH",

      architecture:
        "M15+M5-ALIGNED-SIGNAL + H1-HOLD + H1-SR-TARGET + M15/M5-ROADBLOCK + FIXED-ENTRY-SL-TP + AUTHENTICATED-BACKGROUND-PUSH + EVENT-DEDUPE + TIMEFRAME-CACHE + LIVE-PRICE",
