export default async function handler(req, res) {
  try {
    ...
    // M5 ONLY:
    // lower threshold because this is specifically for scalping
    ...
    return res.status(200).json({
      ...
      version: "V6-M5-ONLY-MANIPULATION",
